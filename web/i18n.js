...
const T = {
  en: {
    ...
    modal: { open: '▶ Open YouTube', verify: 'Verify & Claim', verifying: 'Verifying…', verifyIn: 'Verify ({{s}}s)', openFirst: 'Open YouTube first — the timer starts when you do.', waitMore: 'Wait {{s}}s more, then verify.', done: 'Done', invalidLink: 'This campaign has an invalid link — try another task.', unavailable: 'This task is no longer available.' },
  ...
  ar: {
    ...
    modal: { open: '▶ افتح YouTube', verify: 'تحقّق واحصل', verifying: 'جارٍ التحقّق…', verifyIn: 'تحقّق ({{s}}ث)', openFirst: 'افتح YouTube أولًا — يبدأ المؤقّت عندها.', waitMore: 'انتظر {{s}} ثانية أخرى ثم تحقّق.', done: 'تم', invalidLink: 'هذه الحملة تحتوي على رابط غير صالح — جرّب مهمة أخرى.', unavailable: 'لم تعد هذه المهمة متاحة.' },
  ...
  ru: {
    ...
    modal: { open: '▶ Открыть YouTube', verify: 'Проверить и получить', verifying: 'Проверка…', verifyIn: 'Проверить ({{s}}с)', openFirst: 'Сначала откройте YouTube — тогда запустится таймер.', waitMore: 'Подождите ещё {{s}}с, затем подтвердите.', done: 'Готово', invalidLink: 'У этой кампании недействительная ссылка — попробуйте другое задание.', unavailable: 'Это задание больше недоступно.' },
  ...
  'zh-CN': {
    ...
    modal: { open: '▶ 打开 YouTube', verify: '验证并领取', verifying: '验证中…', verifyIn: '验证（{{s}}秒）', openFirst: '请先打开 YouTube — 计时器随后开始。', waitMore: '再等 {{s}} 秒后再验证。', done: '完成', invalidLink: '此活动的链接无效 — 请试试其他任务。', unavailable: '此任务已不再可用。' },
  ...
  'zh-TW': {
    ...
    modal: { open: '▶ 開啟 YouTube', verify: '驗證並領取', verifying: '驗證中…', verifyIn: '驗證（{{s}}秒）', openFirst: '請先開啟 YouTube — 計時器隨後開始。', waitMore: '再等 {{s}} 秒後再驗證。', done: '完成', invalidLink: '此活動的連結無效 — 請試試其他任務。', unavailable: '此任務已不再提供。' },
  ...
  bn: {
    ...
    modal: { open: '▶ YouTube খুলুন', verify: 'যাচাই করে নিন', verifying: 'যাচাই হচ্ছে…', verifyIn: 'যাচাই ({{s}}সে)', openFirst: 'আগে YouTube খুলুন — তখনই টাইমার শুরু হয়।', waitMore: 'আরও {{s}} সেকেন্ড অপেক্ষা করে যাচাই করুন।', done: 'সম্পন্ন', invalidLink: 'এই ক্যাম্পেইনের লিঙ্কটি অবৈধ — অন্য একটি কাজ চেষ্টা করুন।', unavailable: 'এই কাজটি আর উপলব্ধ নেই।' },
  ...
  ja: {
    ...
    modal: { open: '▶ YouTube を開く', verify: '確認して受け取る', verifying: '確認中…', verifyIn: '確認（{{s}}秒）', openFirst: '先に YouTube を開いてください — タイマーはそのとき開始します。', waitMore: 'あと {{s}} 秒待ってから確認してください。', done: '完了', invalidLink: 'このキャンペーンのリンクは無効です — 別のタスクをお試しください。', unavailable: 'このタスクはもう利用できません。' },
  ...
  ko: {
    ...
    modal: { open: '▶ YouTube 열기', verify: '확인하고 받기', verifying: '확인 중…', verifyIn: '확인 ({{s}}초)', openFirst: '먼저 YouTube를 여세요 — 그때 타이머가 시작됩니다.', waitMore: '{{s}}초 더 기다린 후 확인하세요.', done: '완료', invalidLink: '이 캠페인의 링크가 잘못되었습니다 — 다른 작업을 시도하세요.', unavailable: '이 작업은 더 이상 제공되지 않습니다.' },
