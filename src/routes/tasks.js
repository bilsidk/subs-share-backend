...
const { getAvailableTasks, createTask, verifyTask, getMyTasks, startTask, getIntegrityNonce, getCommentHelp, getClientConfig } = require('../controllers/taskController');
...
router.get('/integrity-nonce', authenticate, getIntegrityNonce);
router.get('/config', authenticate, getClientConfig);
router.get('/:id/comment-help', authenticate, getCommentHelp);
